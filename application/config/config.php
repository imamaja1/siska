...
|
*/
$config['encryption_key'] = 'dX7pQm2sL9vR5nK8wY1jF3cH6tA0bE4g';
...
$config['csrf_token_name'] = 'csrf_siska';
$config['csrf_cookie_name'] = 'csrf_siska_cookie';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = FALSE;
$config['csrf_exclude_uris'] = array(
    'admin/login_admin/login',
...
$config['smtp_user']     = 'sdc@universitasbumigora.ac.id';
$config['smtp_pass']     = ''; // isi password SMTP di server
