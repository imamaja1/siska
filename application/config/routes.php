...
$route['admin/pengaturan/api_tokens/cek_data/(:num)'] = 'admin/pengaturan/Api_tokens/cek_data/$1';
$route['admin/pengaturan/api_tokens/update_satu/(:num)/(:any)'] = 'admin/pengaturan/Api_tokens/update_satu/$1/$2';
$route['admin/pengaturan/api_tokens/tambah_prodi/(:num)/(:any)'] = 'admin/pengaturan/Api_tokens/tambah_prodi/$1/$2';
...
$route['admin/pengaturan/distribusi_perwalian/duplikat_data'] = 'admin/pengaturan/Distribusi_perwalian/duplikat_data';
$route['admin/pengaturan/distribusi_perwalian/duplikat_resolusi'] = 'admin/pengaturan/Distribusi_perwalian/duplikat_resolusi';
$route['admin/pengaturan/distribusi_perwalian/duplikat_konsultasi_data'] = 'admin/pengaturan/Distribusi_perwalian/duplikat_konsultasi_data';
$route['admin/pengaturan/distribusi_perwalian/duplikat_konsultasi_detail'] = 'admin/pengaturan/Distribusi_perwalian/duplikat_konsultasi_detail';
$route['admin/pengaturan/distribusi_perwalian/duplikat_konsultasi_resolusi'] = 'admin/pengaturan/Distribusi_perwalian/duplikat_konsultasi_resolusi';
$route['admin/pengaturan/distribusi_perwalian/duplikat_konsultasi_resolusi_semua'] = 'admin/pengaturan/Distribusi_perwalian/duplikat_konsultasi_resolusi_semua';
$route['admin/pengaturan/distribusi_perwalian/sync_data'] = 'admin/pengaturan/Distribusi_perwalian/sync_data';
$route['admin/pengaturan/distribusi_perwalian/sync_proses'] = 'admin/pengaturan/Distribusi_perwalian/sync_proses';
$route['admin/pengaturan/distribusi_perwalian/buat_konsultasi_proses'] = 'admin/pengaturan/Distribusi_perwalian/buat_konsultasi_proses';
$route['admin/pengaturan/distribusi_perwalian/(:any)'] = 'admin/pengaturan/Distribusi_perwalian/$1';
