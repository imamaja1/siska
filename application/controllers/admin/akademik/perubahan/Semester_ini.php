...
class Semester_ini extends CI_Controller {
    ...
    public function index() {
        $data['judul'] = "Akademik";
        $data['sub_judul'] = "KRS & Nilai Semester Ini";
        $data['judul_sub_judul'] = "Perubahan";
        $data['content'] = "admin/akademik/perubahan/semester_ini/V_index.php";
...
//            $nilai_akhir = ($row->nilai_harian * 20 / 100) + ($row->nilai_uts * 30 / 100) + ($row->nilai_uas * 50 / 100);
        ...
        // $data['matakuliah'] = $this->m_data_kurikulum->get_matakuliah_by_nim_semester($nim, semester());
      
        $data['judul'] = "Krs dan NIlai";
        $data['sub_judul'] = "Semester Ini";
        $data['content'] = "admin/akademik/perubahan/semester_ini/V_krs_nilai";
