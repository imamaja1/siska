...
//        $query = $this->db->get_where('matakuliah_prasyarat', array('matakuliah_yg_diambil' => $kode_matakuliah, 'kode_nama_kurikulum'=>$kode_nama_kurikulum))->row_object();
    ...
    {
        return $this->db->select('krs.kode_tahun_akademik, ta.tahun_akademik as nama_ta, krs.semester, krs.kode_krs, krs_detail.kode_krs_detail, krs_detail.status, krs_detail.nilai_akhir as na_krs, matakuliah.kode_matakuliah, matakuliah.nama_matakuliah, matakuliah.sks_teori, matakuliah.sks_praktek, matakuliah.sks_praktikum, khs_detail.nilai_harian, khs_detail.nilai_uts, khs_detail.nilai_uas, khs_detail.nilai_akhir, khs_detail.tidak_berhak')
                ->from('krs')
                ->join('krs_detail', 'krs_detail.kode_krs = krs.kode_krs')
