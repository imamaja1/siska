<div class="box box-solid flat">
    <div class="box-body">
        <a href="<?= site_url('admin/akademik/mahasiswa') ?>" class="btn btn-xs btn-success flat"><i class="fa fa-arrow-left"></i> Kembali</a>
    </div>
</div>
<div class="box box-solid flat">
    ...
    <div class="box-body"><br>
        ...
        <form id="myform" class="form-horizontal" action="<?= site_url('admin/akademik/mahasiswa/simpan_update') ?>" method="POST"  enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <select name="status" class="form-control select2">
                        <option <?= $data_mahasiswa->status == 'A' ? 'selected' : '' ?> value="A">Aktif</option>
                        <option <?= $data_mahasiswa->status == 'N' ? 'selected' : '' ?> value="N">Tidak</option>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" value="<?= set_value('nama_mahasiswa', $data_mahasiswa->nama_mahasiswa) ?>" name="nama_mahasiswa">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input readonly type="email" class="form-control" value="<?= set_value('email', $data_mahasiswa->nim . "@universitasbumigora.ac.id") ?>" name="email">
                </div>
            </div>
...
<!--                <div class="col-sm-3">-->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <a href="<?= site_url('admin/akademik/mahasiswa'); ?>" class="btn btn-default flat"><i class="fa fa-remove"></i> Batal</a>
...
<script>
    ...
    function readURL(input,id) {
        if (input.files && input.files[0]) {
            ...
            var action = "<?= site_url('admin/akademik/mahasiswa/upload_image') ?>/"+id;
