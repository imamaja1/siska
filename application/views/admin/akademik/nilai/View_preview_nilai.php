<div class="col-md-12">
    <dl class="dl-horizontal">
        ...
        <dd><?= $kode_matakuliah == "" ? "<span class='badge bg-red'>Tidak boleh kosong</span>" : $kode_matakuliah ?></dd>
        <dt>NAMA MATAKULIAH :</dt>
        <dd><?= $nama_matakuliah ?></dd>
    </dl>
                ...
                <table class="table demo-table">
                    ...
                    <?php $no=1; foreach ($data as $row) : ?>
                        <tr>
                            ...
                            <td style="text-align: center"><?= $row['nim'] == "" ? "<span class='badge bg-red'>Tidak boleh kosong</span>" : $row['nim'] ?></td>
                            ...
                            <td style="text-align: center"><?= $row['nilai_akhir'] == "" ? "<span class='badge bg-red'>Tidak boleh kosong</span>" : $row['nilai_akhir'] ?></td>
                            <td style="text-align: center"><?= $row['grade'] ?></td>
                            <td style="text-align: center"><?= $row['tidak_berhak'] == "" ? "<span class='badge bg-red'>Tidak boleh kosong</span>" : $row['tidak_berhak'] ?></td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
