...
<script>
    ...
    function filter() {
        ...
        if (id) {
            $.ajax({
                url : "<?= base_url("admin/akademik/nilai/tanggal_aktivasi"); ?>"+"/"+id,
                beforeSend : function () {
                    $("#landing").html(loader);
                },
    ...
    function generit() {
        $.ajax({
            url : "<?= base_url("admin/akademik/nilai/generit_aktivasi"); ?>"+"/"+id,
            beforeSend : function () {
                $("#landing").html(loader);
            },
            success : function (res) {
    ...
    function update_uts(){
        $.ajax({
            url : "<?= base_url("admin/akademik/nilai/update_aktivasi_uts"); ?>"+"/"+id,
            type: "POST",    
            data: {
    ...
    function update_uas(){
        $.ajax({
            url : "<?= base_url("admin/akademik/nilai/update_aktivasi_uas"); ?>"+"/"+id,
            type: "POST",    
            data: {
