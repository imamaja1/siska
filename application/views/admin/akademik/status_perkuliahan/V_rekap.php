<div class="box box-primary">
    <div class="box-header">
        <h3 class="box-title">TA. <?php $ta = tahun_akademik(); echo e($ta ? $ta->tahun_akademik : '-'); ?> <?= $ta ? ($ta->semester == 0 ? 'GENAP' : 'GANJIL') : '' ?> / Podi <?= e(isset($prodi->nama_program_studi) ? $prodi->nama_program_studi : '-') ?></h3>
        <div class="box-tools">
