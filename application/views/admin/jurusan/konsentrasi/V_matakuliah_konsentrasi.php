        ...
        <div class="box box-solid">
            ...
            <div class="box-body">
                <form action="<?= site_url('admin/jurusan/konsentrasi/simpan_matakuliah') ?>" method="post">
                    <input type="hidden" name="kode_kompetensi" value="<?= $konsentrasi->kode_kompetensi ?>">
        ...
        <div class="box">
            <div class="box-header">
                <h4><span class="text-warning"><i class="fa fa-book"></i></span> Matakuliah Konsentrasi
                    <b><?= $konsentrasi->nama_kompetensi ?></b></h4>
            </div>
            <div class="box-body">
                    ...
                    <table class="table table-bordered table-striped data-table">
                        ...
                        <?php foreach ($lists as $key => $row) : ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="<?= site_url('admin/jurusan/konsentrasi/delete_matakuliah/'.$row->id) ?>" class="btn btn-danger btn-sm" title="Delete Matakuliah"><i
