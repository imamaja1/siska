...
<?php if (count($data) > 0): ?>
    <?php foreach ($data as $row): ?>
        <div class="box box-primary flat">
            <div class="box-body">
                <a class="btn btn-primary btn-xs flat pull-right" id="tambah" data-toggle="modal" onclick="isi_data_kurikulum('<?= e($row['semester']) ?>')"><i class="fa fa-plus-circle"></i> Tambah Data Kurikululm</a>
                           ...
                           $j_pm += $d->sks_praktikum;
                            ...
                            <tr <?= in_array($d->id_matakuliah, $mk_pilihan) ? "style='font-style: italic'" : "" ?> <?=($d->jenis == '1')? 'style="font-style: italic"':"style='font-weight: bold'";?>>
                                ...
                                <td style="text-align: center">&nbsp;
                                    <a href="#" onclick="hapus('<?= site_url('admin/jurusan/kurikulum/data_kurikulum/hapus/' . $d->kode_kurikulum . "/" . $d->kode_nama_kurikulum) ?>')" class="btn btn-xs btn-danger flat"> <i class="fa fa-trash"></i> Hapus</a>
                                </td>
                                <div style="display: none;" id="kode-nama-<?= e($d->kode_kurikulum) ?>"><?= e($d->kode_nama_kurikulum) ?></div>
                                <div style="display: none;" id="kode-kurikulum-<?= e($d->kode_kurikulum) ?>"><?= e($d->kode_kurikulum) ?></div>
                            </tr>
                        <?php } ?>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="<?= site_url('admin/jurusan/kurikulum/data_kurikulum/simpan_data_kurikulum') ?>">
