...
<div class="box box-solid flat">
    <div class="box-body">
        <div class="col-md-6 col-sm-12" style="padding: 0px">
            <a href="#" id="tambah" class="btn btn-primary flat" data-toggle="modal"
                onclick="$('#myModal').modal('toggle')"> <i class="fa fa-plus-circle"></i> Tambah</a>
        </div>
        <div class="col-md-6 col-sm-12" style="padding: 0px">
                    ...
                    <div class="col-sm-9">
                        <select name="kode_program_studi" id="kode-program-studi" class="form-control">
                            <?php foreach ($jurusan as $row): ?>
                                <option <?= $row->kode_program_studi == 2 ? 'selected' : '' ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-add-matakuliah" method="POST"
                    action="<?= site_url('admin/jurusan/kurikulum/matakuliah/tambah_matakuliah') ?>">
                    <div class="form-group">
                        <label>Kode Matakuliah<span class="text-danger">*</span></label>
                        <input required type="text" name="kode_matakuliah" class="form-control"
                            placeholder="Kode Matakuliah">
                    </div>
                    <div class="form-group">
                        <label>Nama Matakuliah<span class="text-danger">*</span></label>
                        <input required type="text" name="nama_matakuliah" class="form-control"
                            ...
                            <div class="col-xs-4">
                                ...
                                <select name="kode_kompetensi" class="form-control">
                                    ...
                                    <?php foreach ($kompetensi as $k) { ?>
                                        <option value="<?= $k->kode_kompetensi ?>"> <?= $k->nama_kompetensi ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="col-xs-4">
                    ...
                    <div class="form-group">
                        ...
                        <select required name="kode_nama_jurusan" class="form-control">
                            ...
                            <?php foreach ($jurusan as $j) { ?>
                                <option value="<?= $j->kode_program_studi ?>"><?= $j->singkatan_program_studi ?></option>
                            <?php } ?>
                        </select>
                    </div>
...
<div class="modal fade" id="edit-matakuliah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="form-edit-matakuliah"
                    action="<?= site_url('admin/jurusan/kurikulum/matakuliah/ubah_matakuliah') ?>">
                    <div class="form-group">
                        <label>Kode Matakuliah</label>
                        <input readonly type="hidden" name="param_edit" id="param">
                        <input required type="text" name="kode_matakuliah" class="form-control"
                            placeholder="Kode Matakuliah" id="edit-kode-matakuliah">
                    </div>
                    <div class="form-group">
                        <label>Nama Matakuliah</label>
                        <input required type="text" name="nama_matakuliah" class="form-control"
                            placeholder="Nama Matakuliah" id="edit-nama-matakuliah">
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-xs-4">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <label>Jenis</label>
                                <select name="jenis" class="form-control" id="edit-jenis">
                            ...
                            <div class="col-xs-4">
                                <label>Block (Kedokteran)</label>
                                <select name="block" class="form-control" id="edit-block">
                                    <option value="0">Non Block</option>
                                    <option value="1">Block</option>
                                </select>
                            </div>
    ...
    $(document).ready(function () {
        ...
        $("#form-add-matakuliah").submit(function (e) {
            ...
            if (!$(this)[0].checkValidity()) {
                console.log('form harus di isi semua');
            } else {
                $.ajax({
                    url: url,
                    data: data,
