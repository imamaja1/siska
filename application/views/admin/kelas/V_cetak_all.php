...
$matakuliah = $CI->kelas_model->get_matakuliah_by_kode_tahun_akademik($kode_tahun_akademik);
foreach ($matakuliah as $mak)
{
    $kelas = $CI->kelas_model->get_kelas_by_kode_makul($mak->id_matakuliah, $kode_tahun_akademik);
