...
<script>
  ...
  $('#matakuliah').val("<?= $matakuliah->id_matakuliah ?>");
    ...
    function load_pegampu() {
        var url = "<?= site_url('admin/kuisioner/kelas/pengampu') ?>/" + super_kelas_id;
        $.ajax({
            url: url,
            success: function (res) {
    ...
    function hapus_pengampu(id) {
        var url = "<?= site_url('admin/kuisioner/kelas/hapus_pengampu') ?>/" + id;
        swal({
            title: '',
            text: "Anda yaikin menghapus data ini?",
            type: 'warning',
...
<script>
    $(document).ready(function () {
        ...
        $("#form-tambah-pengampu").submit(function (e) {
            e.preventDefault();
            var url = "<?= site_url('admin/kuisioner/kelas/simpan_pengampu') ?>/" + super_kelas_id;
            var data = $(this).serialize();
            $.ajax({
                url: url,
                type: 'post',
