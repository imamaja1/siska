...
<script>
                                            ...
                                            function generate(id_matakuliah) {
                                                var url = "<?= site_url('admin/kuisioner/kelas/generate_kelas') ?>/" + kode_program_studi + "/" + id_matakuliah + "/" + kode_tahun_akademik_mega;
                                                $.ajax({
                                                    url: url,
                                                    beforeSend: function () {
                                            ...
                                            function kelas(id_matakuliah) {
                                                ...
                                                var url = "<?= site_url('admin/kuisioner/kelas/get_nama_kelas') ?>/" + kode_program_studi + "/" + id_matakuliah + "/" + kode_tahun_akademik_mega;
