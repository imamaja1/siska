<div class="box box-solid flat">
    <div class="box-body">
        ...
        <div class="pull-right">
            <a href="<?= site_url('admin/laporan/rekap_ipk/ipk_rata') ?>" class="btn btn-sm btn-primary"><i class="fa fa-line-chart"></i> Rata-rata IPK</a>
        </div>
    </div>
</div>
            ...
            <table class="table demo-table">
                <thead>
                    <tr>
                        ...
                        <th id="th">NIM</th>
                        <th id="th">NAMA</th>
                        <th id="th">SKS (SEMESTER)</th>
                        <th id="th">IP (SEMESTER)</th>
                        <th id="th">IPK</th>
                        <th id="th">SKS TOTAL</th>
                    </tr>
                </thead>
                <tbody>
