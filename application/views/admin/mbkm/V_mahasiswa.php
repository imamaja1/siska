...
<script>
    ...
    function mahasiswa() {
        $.ajax({
            ...
            url: '<?= site_url('admin/mbkm/daftar/get_mahasiswa') ?>',
            type: 'get',
            beforeSend: function () {
    ...
    function mhs_ta(){
        $ta = $('#ta').val();
         $.ajax({
            //url : '<? //= site_url('admin/kuisioner/kelas/dropdown_makul') ?>///'+id,
            url: '<?= site_url('admin/mbkm/daftar/get_mahasiswa') ?>/'+$ta,
            type: 'get',
            beforeSend: function () {
                $('#landing-mahasiswa').html(loader);
            },
    ...
    function Search(){
        ...
        $.ajax({
            //url : '<? //= site_url('admin/kuisioner/kelas/dropdown_makul') ?>///'+id,
            url: '<?= site_url('admin/mbkm/daftar/search_mahasiswa') ?>/'+$nim +'/'+$ta,
            type: 'get',
            beforeSend: function () {
    ...
    function update(nim){
        ...
        $.ajax({
            //url : '<? //= site_url('admin/kuisioner/kelas/dropdown_makul') ?>///'+id,
            url: '<?= site_url('admin/mbkm/daftar/tambah_mhs_mbkm') ?>/'+nim +'/'+ta,
            type: 'get',
            success: function (data) {
                Search();
                mhs_ta();
    ...
    function hapus(id){
        $.ajax({
            //url : '<? //= site_url('admin/kuisioner/kelas/dropdown_makul') ?>///'+id,
            url: '<?= site_url('admin/mbkm/daftar/hapus_mhs_mbkm') ?>/'+id ,
            type: 'get',
            success: function (data) {
