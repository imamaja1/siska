<html>
    ...
    <body style="font-family: cambria;">
        ...
        <table class="tableone" border="1" style="border-collapse: collapse; font-size: 12px;">
            <thead>
                <tr>
                    ...
                    <td class="padding" rowspan="2" align="center">Status</td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                foreach ($query2 as $row):
                    ...
                    <tr>
                        ...
                        <td align="center"><?= e($row->nilai_harian) ?></td>
                        <td align="center"><?= e($row->nilai_uts) ?></td>
                        <td align="center"><?= e($row->nilai_uas) ?></td>
        ...
        <table style="border-collapse: collapse; font-size: 12px;">
            <tr>
                <td>Keterangan:</td>
                <td>NA = (HARIAN x <?= e($query1->nilai_harian) ?>%)+(UTS x <?= e($query1->nilai_uts) ?>%)+(UAS x <?= e($query1->nilai_uas) ?>%)</td>
            </tr>
            <tr>
                <td></td>
                <td>GRADE:<br>
