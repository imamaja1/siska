...
function show_nilai(param1,param2) {
    $.ajax({
        url: '<?= site_url('dosen/dekan/validasinilai/revisi_nilai_validasi')?>',
        type: 'post',
        data: {
            "kelas": param1,
            "level": param2,
...
function show_mhs(param1,param2) {
    $.ajax({
        url: '<?= site_url('dosen/dekan/validasinilai/revisi_nilai_validasi_mhs')?>',
        type: 'post',
        data: {
            "kelas": param1,
            "level": param2,
...
function selesai(param1,param2) {
    swal({
            ...
            $.ajax({
                url: '<?= site_url('dosen/dekan/validasinilai/revisi_nilai_selesai')?>',
                type: 'post',
                data: {
                    "kelas": param1,
                    "level": param2,
...
function revisi(param1,param2) {
    ...
    swal({
        ...
        if( pesan == '') {
            ...
            $.ajax({
                url: '<?= site_url('dosen/dekan/validasinilai/revisi_nilai_revisi')?>',
                type: 'post',
                data: {
                    "kelas": param1,
                    "level": param2,
...
function autoload2() {
    var url = "<?= site_url('dosen/dekan/validasinilai/choose_nilai_revisi') ?>";
    $.ajax({
        url: url,
        beforeSend: function () {
...
function refres() {
    const url = "<?= site_url('dosen/dekan/validasinilai/choose_nilai_revisi') ?>";
    $.ajax({
        url: url,
        data: {
