...
<script>
    ...
    function lihat(kelas_id) {
      ...
      function lihat_mhs(kelas_id) {
        super_kelas_id = kelas_id;
        var url = "<?= site_url('dosen/dekan/validasinilai/lihat_data_mahasiswa_uts') ?>/" + kelas_id;
        $.ajax({
            url: url,
            success: function (res) {
                $("#landing-lihat").html(res);
    ...
    function pesan_uts(kelas_id) {
        super_kelas_id = kelas_id;
        var url = "<?= site_url('dosen/penilaian/pesan_uts') ?>/" + kelas_id +'/dekan/dosen';
        console.log(url);
        $.ajax({
            url: url,
            success: function (res) {
