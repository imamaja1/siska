<div class="box box-warning">
    ...
    <div class="box-footer">
        <?php if ($data_kelas->status_uts_dosen == 'T' && $data_kelas->status_uts_prodi == 'T') : ?>
            <?php if ($data_kelas->status_uts_dekan != 'T') : ?>
                <form action="<?= site_url('dosen/dekan/update_penilaian/revisi_uts') ?>" method="post">
                    ...
                    <a onclick="validasi_uts()" href="#" class="btn btn-primary btn-flat pull-left"
