...
<div class="box box-solid flat">
    <div class="box-body">
        <table class="table table-bordered table-condensed">
            <tr>
                <th>Jumlah dosen pada prodi anda (HomeBase)</th>
                            ...
                            foreach ($data_bidang_ilmu as $dbi) {
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <button class="btn btn-primary btn-xs" onclick="show_jumlah_dosen('<?= e($dbi->id_bidang_ilmu) ?>')"><i class="fa fa-eye"></i></button>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
