                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button class="btn btn-info btn-xs btn-flat" data-toggle="modal" data-target="#ModalNilai" onclick="show_mhs(<?= $row->kelas_id ?>,<?= $row->data_kelas->level ?>)"><i class="fa fa-eye"></i></button>
