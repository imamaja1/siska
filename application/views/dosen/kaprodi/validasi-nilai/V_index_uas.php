...
<script>
    ...
    function kelas() {
        var url = "<?= site_url('dosen/kaprodi/validasinilai/kelas_uas') ?>";
        $.ajax({
            url: url,
            beforeSend: function () {
    ...
    function pesan_uas(kelas_id) {
        super_kelas_id = kelas_id;
        var url = "<?= site_url('dosen/penilaian/pesan_uas') ?>/" + kelas_id +'/prodi/dosen';
        console.log(url);
        $.ajax({
            url: url,
            success: function (res) {
    ...
    function lihat_mhs(kelas_id) {
        super_kelas_id = kelas_id;
        var url = "<?= site_url('dosen/kaprodi/validasinilai/lihat_data_mahasiswa_uas') ?>/" + kelas_id;
        $.ajax({
            url: url,
            // beforeSend: function () {
            //     $("#landing-nilai").html(loader);
