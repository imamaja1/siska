                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group"
                                                ...
                                                <input type="text" id="<?= $key ?>"
                                                       value="<?= $row->harian ? $row->harian:$row->nilai_harian ?>"
                                                       class="form-control harian-<?= $row->kode_khs_detail?>"
                                                       placeholder="Enter ..." <?= $data_kelas->status_dosen == 'T' ? 'disabled':'' ?>>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group "
                                                 style="margin: 0px">
                                                <input type="text" id="<?= $key ?>"
                                                       value="<?= $row->uts ? $row->uts:$row->nilai_uts  ?>"
                                        ...
                                        <td>
                                            <div class="form-group"
                                                 style="margin: 0px">
                                                <input type="text" id="<?= $key ?>"
                                                       value="<?= $row->uas ? $row->uas:$row->nilai_uas ?>"
                                                       class="form-control uas-<?= $row->kode_khs_detail?>"
                                                       placeholder="Enter ..."  <?= $data_kelas->status_dosen == 'T' ? 'disabled':'' ?>>
                                            </div>
                                        <td><p id="na<?= $key ?>"><?= round($row->na ? $row->na:$row->nilai_akhir) ?></p></td>
                                        <td><p id="grade<?= $key ?>"> <?= $row->grade ?> </p></td>
