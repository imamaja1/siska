...
<?php if ($nilai): ?>
<?php if ($kelas->status_dosen == 'T' && $kelas->status_prodi != 'T'):?>
 <div class="row" style="margin-top: 15px">
    <div class="col-md-12 col-xs-12">
        ...
        <div class = "pt-3 mt-3">
            ...
            <button class="btn btn-danger " onclick="revisi(<?= e($kelas->id_kelas) ?>,<?= e($kelas->level) ?>)" ><i class="fa fa-check-square-o"></i>Revisi Nilai</button>
        </div>
    </div>
</div>
<?php endif; ?>
