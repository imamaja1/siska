...
<div class="box box-primary flat">
    <div class="box-body flat table-responsive">
        ...
        <p style="text-align: center"><strong>SEMESTER <?= $tahun_akademik->semester % 2 == (0)? "GENAP" : "GANJIL" ?> <?= $tahun_akademik->ta ?></strong></p>
                ...
                <td width="50%">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td> : <?= $data_mahasiswa->alamat_orangtua ?></td>
                        </tr>
                        <tr>
                            <th>Telp</th>
        ...
        <table class="table demo-table">
            ...
            foreach ($data as $row) : ?>
                <tr>
                    ...
                    <td width="100"><center><?= $row->sks_teori != 0 ? $row->sks_teori : '' ?></center></td>
                    <td width="100"><center><?= $row->sks_praktek != 0 ? $row->sks_praktek : '' ?></center></td>
                    <td width="100"><center><?= $row->sks_praktikum != 0 ? $row->sks_praktikum : '' ?></center></td>
                    <?php if ($row->status == "B") : ?>
                        <td width="100">
            ...
            <td width="50%">
                <table class="table" width="100%">
                    ...
                    <tr>
                        ...
                        <td width="3%">:</td>
                        <td width="20%"><?= $beban_sks['beban_sks'] ?></td>
                    </tr>
                </table>
            </td>
            <td width="50%">
