...
<div class="box box-solid flat">
    <div class="box-body">
        ...
        <a href="<?= site_url('dosen/konsultasi_perwalian/pencarian_konsultasi_umum') ?>"
           class="btn btn-xs flat btn-info"><i class="fa fa-clone"></i> Konsultasi Umum</a>
        <a href="<?= site_url('dosen/konsultasi_perwalian/export_perwalian') ?>"
           class="btn btn-xs flat btn-danger"><i class="fa fa-file-pdf-o"></i> Export Perwalian</a>
    </div>
</div>
...
<script>
    ...
    function wa(id){
        ...
        if (data.slice(0, 1) == '8') {
            data = 62+data.slice('0', data.length);
        }else if(data.slice(0, 1) == '0'){
            data = 62+data.slice('1', data.length);
        }else if(data.slice(0, 2) == '62'){
            
        }else{
          console.log('cacat');  
        }
        const whatsappURL = "https://wa.me/" + data;
