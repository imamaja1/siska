            ...
            if ($row->pesan_prodi) {
                ...
                <div class="direct-chat-msg right ">
                    <div class="direct-chat-info clearfix">
                        <span class="direct-chat-name pull-right"><?= e($prodi) ?></span>
                        <span class="direct-chat-timestamp pull-left">Tanggal:<?= tgl_indo($row->tgl_prodi); ?>&nbsp;Jam:<?= date('h:i:s A', strtotime($row->tgl_prodi)) ?></span>
                    </div>
...
<script>
    ...
    buttonSend.addEventListener("click", () => {
        ...
        var url = "<?= site_url('dosen/penilaian/pesan_all_kpat') ?>/" + super_kelas_id + "/koprodi/<?= e($param) ?>";
        $.ajax({
            url: url,
            type: "POST",
            data :{
