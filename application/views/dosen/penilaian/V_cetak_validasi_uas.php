        ...
        <table class="tableone" border="1" style="border-collapse: collapse; font-size: 12px;">
            <thead>
                <tr>
                    ...
                    <th class="padding" align="center" style="width: 100px;">NILAI HARIAN</th>
                    <th class="padding" align="center" style="width: 100px;">NILAI UTS</th>
                    <th class="padding" align="center" style="width: 100px;">NILAI UAS</th>
                    <th class="padding" align="center" style="width: 100px;">NILAI AKHIR</th>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            ...
                            foreach ($data_penilaian as $key) {
                                if (($key['nilai_minimum'] <= $row->dummy_na) && ($row->dummy_na <= $key['nilai_maksimum'])) {
                                    echo $key['grade'];
                                }
                            }
                            ?>
