        ...
        <tbody>
            ...
            foreach ($data as $key1 => $row) :
                ...
                <td style="white-space: nowrap;width: 1px;">
                    <a class="btn btn-<?= $row->status_dosen != 'T' ? 'warning' : 'info'; ?> btn-xs btn-flat" href="<?= site_url('dosen/penilaian/nilai_mahasiswa_uas_revisi/' . $row->kelas_id) ?>"> <i class="fa fa-arrow-circle-right"></i>
