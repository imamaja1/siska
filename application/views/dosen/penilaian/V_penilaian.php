                ...
                <?php if (count($data) > 0): ?>
                    <?php if (count($persentasi_nilai) == 0): ?>
                        <div class="alert alert-warning alert-dismissible flat">
                            ...
                            Anda belum menentukan <b>Persentasi penilaian</b> untuk kelas ini. Silahkan menginputkan
                            <b>Persentasi
                                penilaian</b> dengan mengklik tombol
                            <button type="button" class="btn btn-info btn-xs" data-toggle="modal"
                                    data-target="#modal-persentasi-nilai">
                                <i class="fa fa-plus-circle"></i> Add Persentasi Nilai
                            </button>
                        </div>
                    <?php endif; ?>
            ...
            <div class="modal-content">
                <form action="<?= site_url('dosen/penilaian/update_persentasi_penilaian/' . $persentasi_nilai->id) ?>"
                    ...
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span></button>
                        <h4 class="modal-title"><i class="fa fa-edit"></i> Update Persentasi Nilai</h4>
                    </div>
                    <div class="modal-body">
                        <div id="flash-info">
                        </div>
                        ...
                        <div class="text-danger">Jumlah Presentase Nilai Harus 100%</div>
                    </div>
                    <div class="modal-footer">
            ...
            <div class="modal-content">
                <form action="<?= site_url('dosen/penilaian/store_persentasi_penilaian') ?>" method="post">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span></button>
                        <h4 class="modal-title"><i class="fa fa-info-circle"></i> Setting Persentasi Nilai</h4>
                    </div>
                    <div class="modal-body">
                        <div id="flash-info">
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Simpan</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    var notif = ' <div class="alert alert-warning alert-dismissible flat">\n' +
            '                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>\n' +
            '                            <h4><i class="icon fa fa-warning"></i> Warning!</h4>\n' +
            '                            Nilai tidak akan tersimpan sebelum anda menginputkan <b>Persentasi penilaian</b>.\n' +
            '                        </div>';
