...
<div class="modal fade" id="modal-saran" style="display: none;">
    ...
    <script>
        ...
        function pesan_uts_dekan(kelas_id) {
            ...
            var url = "<?= site_url('dosen/penilaian/pesan_uts') ?>/" + kelas_id + "/dosen/dekan";
            $.ajax({
                url: url,
                success: function (res) {
        ...
        function pesan_uts_prodi(kelas_id) {
            super_kelas_id = kelas_id;
            var url = "<?= site_url('dosen/penilaian/pesan_uts') ?>/" + kelas_id + "/dosen/prodi";
            $.ajax({
                url: url,
                success: function (res) {
                    $("#landing-pesan").html(res);
        ...
        $(document).ready(function () {
            ...
            $("#nilai-akademik").change(function (e) {
                var url = "<?= site_url('dosen/penilaian/choose_nilai_uts') ?>";
                var data = $(this).serialize();
                $.ajax({
                    url: url,
                    data: data,
