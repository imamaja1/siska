...
<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
    <ul class="nav navbar-nav">
        <li class="<?= isset($a_dashboard) ? $a_dashboard : ''; ?>"><a
            href="<?= site_url('home/dosen') ?>">Dashboard<span class="sr-only">(current)</span></a></li>
            ...
            <li class="<?= isset($a_penilaian) ? $a_penilaian : ''; ?>"><a href="<?= site_url('dosen/penilaian') ?>">Penilaian</a>
            </li>
            <?php if (isDekan($this->session->userdata('kode_dosen'))) : ?>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Dekan <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="<?= site_url('dosen/kaprodi/ipk') ?>">IPK</a></li>
                        <li><a href="<?= site_url('dosen/dekan/ValidasiNilai') ?>">Validasi Nilai</a></li>
            ...
            <?php if (($this->session->userdata('kode_dosen') == 168) || ($this->session->userdata('kode_dosen') == 10)): ?> 
            <li class="active bg-teal"><a href="<?= site_url('dosen/validasikhusus') ?>">Validasi Nilai</a></li> 
        <?php endif; ?>  
    </ul>
</div>