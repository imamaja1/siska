                    ...
                    for (var e = 0; e < d.columns.editable.length; e++) {
                        ...
                        n.each(function () {
                            ...
                            if ("undefined" != typeof d.columns.editable[e][2]) {
                                ...
                                var a = '<input class="tabledit-input ' + d.inputClass + '" type="number" min="0" max="100" name="' + d.columns.editable[e][1] + '" value="' + t(this).text() + '" style="display: none;" disabled>';
